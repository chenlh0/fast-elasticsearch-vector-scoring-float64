...
public class PluginTest {
    ...
    public void test() throws Exception {
        ...
        final TestObject[] objs = {new TestObject(1, new double[] {0.0d, 0.5d, 1.0d}),
                new TestObject(2, new double[] {0.2d, 0.6d, 0.99d})};
	...
	// Testing Scores
        ...
        Assert.assertEquals(0.99708664, hitsJson.get(0).get("_score").asDouble(), 0);
